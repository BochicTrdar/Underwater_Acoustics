...
# https://gorbatschow.github.io/SonarDocs/sound_absorption_sea_francois.en/
# Sound absorption in sea
from numpy import * 

def sound_absorption_sea_francois(T=None,S=None,D=None,f=None,pH=None):
# Inputs
...
return alpha, Boric, MgSO4, H2O, C
